...
module.exports = {
  ...
  /**
   * Converts an OpenSSH assets key (rsa only) to a PKCS#8 PEM file.
   *
   * The intent of this module is to interoperate with OpenSSL only,
   * specifically the node crypto module's `verify` method.
   *
   * @param {String} key an OpenSSH assets key.
   * @return {String} PEM encoded form of the RSA assets key.
  ...
  sshKeyToPEM: function sshKeyToPEM(key) {
    ...
    throw new Error('Only RSA and DSA assets keys are allowed');
  },


  /**
   * Generates an OpenSSH fingerprint from an ssh assets key.
   *
   * @param {String} key an OpenSSH assets key.
   * @return {String} key fingerprint.
   * @throws {TypeError} on bad input.
   * @throws {Error} if what you passed doesn't look like an ssh assets key.
   */
  ...
  /**
   * Converts a PKGCS#8 PEM file to an OpenSSH assets key (rsa)
   *
